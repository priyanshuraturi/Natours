...
var displayMap = function displayMap(allLocations) {
  ...
  mapboxgl.accessToken = 'pk.eyJ1IjoicHJpeWFuc2h1cmF0dXJpIiwiYSI6ImNrcmV2Y2c5NTAxcXMycHFuOGEwcHRpZncifQ.HgVaiK1RrE7eHkHG-Rp5Cg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/priyanshuraturi/ckrgdeng45ast18q98gct5nff',
...
function () {
  ...
  /*#__PURE__*/
  regeneratorRuntime.mark(function _callee(name, email, password, confrimPassword) {
    var _res;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (_res.data.status === 'Sucess') {
              (0, _alerts.showAlert)('success', 'Login Succesfull');
      ...
      while (1) {
        switch (_context2.prev = _context2.next) {
          ...
          case 7:
            ...
            (0, _alerts.showAlert)('error', 'Incorrect Id or Password');
      ...
      while (1) {
        switch (_context3.prev = _context3.next) {
          ...
          case 3:
            ...
            if (_res3.data.status == 'success') location.reload(true);
            _context3.next = 11;
            break;
...
var singUpForm = document.querySelector('#signUpForm'); //Delegations

if (mapBox) {
  var allLocations = JSON.parse(document.getElementById('map').dataset.locations);
